...
| DefApiNonCpeSoftwareInventory_CL                | Defender for Endpoint REST API | Software inventory for products without CPE mappings.                                                                                | Unique API-only dataset. Useful supplemental inventory source.                                           | Weekly        | Disabled |
...
| DeviceTvmSecureConfigurationAssessment_CL       | Graph Advanced Hunting (KQL)   | Device-level configuration assessment data, primarily configuration IDs.                                                             | Moderate value but limited detail on its own. Often requires joins.                                      | Daily         | Disabled |
...
| DeviceTvmSoftwareVulnerabilities_CL             | Graph Advanced Hunting (KQL)   | Active CVEs per device with useful operational detail.                                                                               | Recommended primary vulnerability assessment dataset.                                                    | Daily         | Disabled |
