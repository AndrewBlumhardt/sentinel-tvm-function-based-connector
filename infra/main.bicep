...
var scheduleDefaults = {
  ...
  Schedule_DefApiSoftwareVulnerabilitiesByMachine: '0 0,30 * * * *'
  Schedule_DefApiMachines: '0 0,30 * * * *'
  ...
  Schedule_DefApiCertificateInventoryAssessment: '0 0,30 * * * *'
  Schedule_DefApiHardwareFirmwareAssessment: '0 0,30 * * * *'
